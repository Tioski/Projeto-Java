        ...
        while (continuar) {
            ...
            switch (opcao) {
                case 1:
                    ...
                    Pessoa pessoaDestino = buscarPessoa(pessoas, numeroDestino, agenciaDestino);
                    if (pessoaDestino == null) {
                        System.out.println("Conta destino não encontrada!");
                        break;
                    }
                    pessoa.transferencia(pessoa, pessoaDestino, valorTransferencia);
                    break;
                case 2:
                    pessoa.gerarExtratoSimples();
                    break;
                case 3:
